...
int main( int argc, char** argv )
{
    ...
    detector = cv::ORB::create(500,1.2f,8,31,0,2,0,31,20);
    descriptor = cv::ORB::create(500,1.2f,8,31,0,2,0,31,20);
    ...
    // 求解pnp
    cv::solvePnPRansac(pts_obj, pts_img, cameraMatrix, cv::Mat(), rvec, tvec, false, 100, 1.0, 0.99, inliers, 0);
